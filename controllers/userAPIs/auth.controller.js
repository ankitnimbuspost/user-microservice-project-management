...
const {sendOTP} = require('../../services/userAPIs/Common.service');
const OTPModel = require("../../models/userAPIs/otp.model");
const dataconfig = require('../../config/data.config');
const path = require('path');
const fs = require("fs");
const QueueService = require("../../services/userAPIs/RabbitMQ.service")
