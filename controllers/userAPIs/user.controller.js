...
const { sendInvitationMail } = require("../../services/userAPIs/Common.service");
const UserSettings = require("../../models/userAPIs/users.settings.model");
const ChatHelper = require("../../socket/ChatHelper");
const { default: mongoose } = require("mongoose");
const UserPlanModel = require("../../models/userAPIs/user-plan.mode");
...
module.exports.createUpdatePricingPlan = async function(req,res){
    const PlanModel = require("../../models/userAPIs/plan.model");
    if (!req.body.plan_id)
